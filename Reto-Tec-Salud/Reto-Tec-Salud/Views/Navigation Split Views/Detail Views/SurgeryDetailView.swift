...
struct SurgeryDetailView: View {
    ...
    var body: some View {
        SplitView(mainContent: mainContent, detailContent: BodyPartView(bodyPart: $selectedBodyPart, contentType: .StepByStep), placeHolder: PlaceHolderView(header: "cirugia virtual", fillerText: "Selecciona una parte del cuerpo para comenzar"), selectedItem: $selectedBodyPart)
    }
